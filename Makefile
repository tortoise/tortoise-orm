...
test_oracle:
	$(py_warn) TORTOISE_TEST_DB="oracle://$(TORTOISE_ORACLE_USER):$(TORTOISE_ORACLE_PASS)@127.0.0.1:1521/$(TORTOISE_ORACLE_DB)?driver=$(TORTOISE_ORACLE_DRIVER)" uv run --frozen pytest $(pytest_opts) --cov-report=
