...
class BaseDBAsyncClient:
    ...
    async def execute_insert(self, query: str, values: list) -> Any:
        ...
        :return: The primary key if it is generated by the DB. (Currently only integer autonumber PK's)
        """
        raise NotImplementedError()  # pragma: nocoverage
    ...
    async def execute_script(self, query: str) -> None:
        ...
        :param query: The SQL string, which will be passed on verbatim. Semicolons is supported here.
        """
        raise NotImplementedError()  # pragma: nocoverage
