...
class TestInitErrors(test.SimpleTestCase):
            ...
            await Tortoise.init(
                {
                    ...
                    "apps": {
                        "models": {
                            "models": ["tortoise.tests.models_dup1"],
                            "default_connection": "default",
                        }
                    },
                }
            ...
            await Tortoise.init(
                {
                    ...
                    "apps": {
                        "models": {
                            "models": ["tortoise.tests.models_dup2"],
                            "default_connection": "default",
                        }
                    },
                }
        ...
        await Tortoise.init(
            {
                ...
                "apps": {"models": {"models": ["tortoise.tests.testmodels"]}},
            }
        )
        self.assertIn("models", Tortoise.apps)
        self.assertIsNotNone(Tortoise.get_connection("default"))
    ...
    async def test_shorthand_init(self):
        await Tortoise.init(
            db_url=f"sqlite://{':memory:'}", modules={"models": ["tortoise.tests.testmodels"]}
        )
        self.assertIn("models", Tortoise.apps)
        self.assertIsNotNone(Tortoise.get_connection("default"))
    ...
    async def test_bad_models(self):
        with self.assertRaisesRegex(
            ConfigurationError, 'Module "tortoise.tests.testmodels2" not found'
        ):
            await Tortoise.init(
                {
                    "connections": {
                    ...
                    "apps": {
                        "models": {
                            "models": ["tortoise.tests.testmodels2"],
                            "default_connection": "default",
                        }
                    },
                }
