...
def test_abstract_meta_ordering_is_inherited() -> None:
    ...
    class InheritsInherited(InheritsOrdering):
        class Meta:
            abstract = True
    ...
    assert InheritsInherited._meta._default_ordering == OrderedBase._meta._default_ordering
