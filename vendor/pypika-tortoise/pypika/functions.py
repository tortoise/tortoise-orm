...
"""
from pypika.enums import SqlTypes, DatePart
from pypika.terms import AggregateFunction, Function, Star, LiteralValue
...
class Extract(Function):
    def __init__(self, date_part: DatePart, field, alias=None):
        super(Extract, self).__init__("EXTRACT", LiteralValue(date_part.value), alias=alias)
        self.field = field
