...
from tortoise.migrations.schema_generator.state_diff import _model_signature, StateModelDiff
...
class OperationGenerator:
    ...
    def _create_model_operation(self, model_state: ModelState) -> CreateModel:
        return CreateModel(
            ...
            bases=[base.__name__ if not isinstance(base, str) else base for base in model_state.bases],
        )
