    ...
    operations = [
        ...
        ops.CreateModel(
            ...
            fields=[
                ...
                ('team', fields.ForeignKeyField('accounts.Team', source_field='team_id', null=True, db_constraint=True, to_field='id', related_name='members', on_delete=OnDelete.CASCADE)),
            ],
